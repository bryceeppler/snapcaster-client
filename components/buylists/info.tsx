      ...
      <section className="relative bg-gradient-to-b from-background to-background/80 py-20">
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl font-montserrat text-lg text-muted-foreground">
              Ship your cards for quick cash or store credit.
            </p>
...
const steps: Step[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://cdn.snapcaster.ca/images/offers.png',
    imageStyle: 'bordered'
  },
  {
...
4. Refresh the buylist page on Snapcaster and submit your quote.`
  ...
  },
  {
    ...
    imageUrl: 'https://cdn.snapcaster.ca/images/review.png',
    imageStyle: 'bordered'
  },
  {
...
4. Fake cards will be seized and will be omitted from your offer.`
    ...
    imageUrl: 'https://cdn.snapcaster.ca/images/catinbox.png'
  }
];
