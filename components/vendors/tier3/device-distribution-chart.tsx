...
export function DeviceDistributionChart({ deviceData, variant }: DeviceDistributionChartProps) {
  ...
  const options: ChartOptions<'doughnut'> = {
    ...
    plugins: {
      ...
      tooltip: {
        backgroundColor: variant === "dark" ? "rgb(30, 41, 59)" : "rgb(255, 255, 255)",
        titleColor: variant === "dark" ? "rgb(255, 255, 255)" : "rgb(15, 23, 42)",
        bodyColor: variant === "dark" ? "rgb(255, 255, 255)" : "rgb(15, 23, 42)",
        borderColor: variant === "dark" ? "rgb(51, 65, 85)" : "rgb(226, 232, 240)",
        borderWidth: 1,
        padding: 12,
        callbacks: {
          label: (context) => {
  ...
  return (
    <Card className="bg-popover/20 text-white h-[400px]">
      <CardHeader>
