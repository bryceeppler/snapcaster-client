export default function Component() {
    return (
      <section className="w-full h-screen flex flex-col items-center px-4 text-center space-y-8">
        <svg
          className=" w-24 h-24 text-green-500 dark:text-green-300 mt-20"
          fill="none"
          height="24"
          stroke="currentColor"
          strokeLinecap="round"
        ...
        <h2 className="text-4xl font-semibold text-gray-300 dark:text-white">Your email is verified!</h2>
