          ...
          <section className="w-full py-6 md:py-12">
            <div className="max-[1fr_900px] container grid items-start gap-6 md:px-6">
              ...
              <p>
                ...
                registered in Canada at Victoria BC , Victoria , British
                Columbia .
              </p>
              <p>
              ...
              <p>
                We aggregate the cheapest options for purchasing trading card
                game cards in Canada.
              </p>
              <p>
              ...
              <p>
                ...
                <strong>"you"</strong>), and Snapcaster, concerning your access
              ...
              <p>
                ...
                epplerdev@gmail.com, as stated in the email message. By
              ...
              <div className="MsoNormal" id="services">
                <strong>
              ...
              <p>
                ...
                Terms, please address your request to: epplerdev@gmail.com. If
              ...
              <div className="MsoNormal" id="userreps">
                <strong>
              ...
              <p>
                ...
                permission to use the Services ; (6) you will not access the
                Services through automated or non-human means, whether through a
                bot, script or otherwise; (7) you will not use the Services for
                any illegal or unauthorized purpose; and (8) your use of the
              ...
              <div className="MsoNormal" id="userreg">
                <strong>
              ...
              <div className="MsoNormal" id="purchases">
                <strong>
              ...
              <p>
                ...
                change prices at any time. All payments shall be in CAD Dollars.
              </p>
              <p>
              ...
              <div className="MsoNormal" id="subscriptions">
                <strong>
              ...
              <p>
                ...
                laws of Canada . Snapcaster and yourself irrevocably consent
              ...
              <p>
                ...
                place, or arbitration shall be Victoria, Canada . The language
