    ...
    <>
      ...
      <div className="container grid max-[1fr_900px] px-4 md:px-6 items-start gap-6">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 dark:text-gray-400">Welcome to Snapcaster!</p>
        </div>
        <div className="grid gap-4 md:gap-4">
          {/* <h3>Welcome to Snapcaster!</h3> */}
          <p>This is a project that I created to help Magic: The Gathering players search for singles on Canadian websites. With Snapcaster, you can search multiple websites at once and see all the results in one place. If you have any suggestions or feedback, please feel free to email me at epplerdev@gmail.com.</p>
          <h3
            className="text-2xl font-bold"
          >Support</h3>
          <p>Snapcaster is a service I created in my spare time, and I rely on donations to cover the server costs. If you find Snapcaster helpful, please consider donating to support the project.</p>
          <Button onClick={
            () => {
