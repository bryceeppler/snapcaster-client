            ...
            <div className="max-[1fr_900px] container grid items-start gap-6 md:px-6">
              ...
              <div className="outlined-container grid gap-4 p-8 md:gap-4">
                <p className="text-left">
                  Snapcaster is a search tool designed for Magic: The Gathering
                  players, letting you search for MTG singles across Canadian
                  websites. It allows users to efficiently search multiple
                  websites simultaneously, aggregating results in a single,
                  convenient location. We are excited to continuously improve
                  the service and welcome all suggestions or feedback.
                </p>
              </div>
            </div>
          </section>
