...
const About: NextPage<Props> = () => {
  return (
    <>
      <AboutHead />
      <MainLayout>
        <div className="w-full max-w-xl flex-1 flex-col justify-center text-left">
...
<li>
<p><strong>Website</strong> refers to Snapcaster, accessible from <a href="https://www.snapcaster.ca" rel="external nofollow noopener" target="_blank">https://www.snapcaster.ca</a></p>
</li>
<li>
