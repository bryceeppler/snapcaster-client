      ...
      <div className="w-full max-w-4xl flex-1 flex-col justify-center text-left">
        <section className="w-full py-6 md:py-12">
          <div className="max-[1fr_900px] container grid items-start gap-6 md:px-6">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Eppler
                  Software, Victoria, British Columbua, CA.
                </p>
              </li>
              <li>
                <p>
            ...
            <p>
              The Company allows You to create you to link the following
            ...
            <p>
              If You decide to connect through or otherwise grant us access to a
            ...
            <h4 className=" font-bold">Tracking Technologies and Cookies</h4>
            <p>
            ...
            <h2 className="text-lg font-bold">Links to Other Websites</h2>
            <p>
