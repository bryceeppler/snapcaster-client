              ...
              <Accordion type="single" collapsible className="grid gap-4">
                <AccordionItem value="what-is-this">
                  ...
                  <AccordionContent className="bg-muted px-4 py-3 text-gray-500">
                    ...
                    65 Canadian online retailers to find the best deals and
                    build the decks of your dreams.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="how-it-works">
                  ...
                  <AccordionContent className="bg-muted px-4 py-3 text-gray-500">
                    Snapcaster works by aggregating listings from various
                    Canadian online retailers into one easy-to-use platform.
                    When you search for a card, Snapcaster scans its extensive
                    database and displays the available options, helping you
                    find the best prices and deals. Our goal make your shopping
                    easier, so you can focus on building the perfect deck.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="add-store">
                  ...
                  <AccordionContent className="bg-muted px-4 py-3 text-gray-500">
                    Absolutely! If you have a Canadian online store that you
                    would like to see on Snapcaster, we'd love to hear from you.
                    Join our Discord community to stay updated, make
                    suggestions, or report any bugs. Your feedback helps us
